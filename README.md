...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-session-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15550&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-session-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-session` can be installed with:

```
conda install flask-session
```

It is possible to list all of the versions of `flask-session` available on your platform with:
